 ...
 * Since promotion is considered first, longs is output.
 * If that method were removed, Java would next go to autoboxing, printing Integers.
 *
 * If both message(long long) and message(Integer Integer) are removed
 * then it calls the method message(varargs)
 */
